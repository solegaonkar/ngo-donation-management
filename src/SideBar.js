           ...
           <div className="sidebar-wrapper">
                ...
                <ul className="nav">
                 <li className="nav-item active ">
                    <a className="nav-link" onClick={() => {props.onLinkClick({showNow: "Dashboard"})}}>
                 ...
                 <li className="nav-item ">
                    ...
                    <div className="collapse" id="activitySidebar">
                       <ul className="nav">
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick({showNow: "Donor Search"})}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donor Create/Update </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Receive Donation")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Receive Donation </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donation Drive")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                 ...
                 <li className="nav-item ">
                    ...
                    <div className="collapse" id="donorReportSidebar">
                       <ul className="nav">
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donor Acquisition")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donor Acquisition </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donor Impact")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donor Impact </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donor Origin")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donor Origin </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donor Analysis")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                 ...
                 <li className="nav-item ">
                    ...
                    <div className="collapse" id="donationReportSidebar">
                       <ul className="nav">
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Drive Impact")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Drive Impact </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donation Trend")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donation Trend </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donation Origin")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donation Origin </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Donation Analysis")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                 ...
                 <li className="nav-item ">
                    ...
                    <div className="collapse" id="donorEngagementSidebar">
                       <ul className="nav">
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Newsletter")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Newsletter </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Communication")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donor Communication </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Soft Reminders")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donation Origin </span>
                             </a>
                          </li>
                          <li className="nav-item ">
                             <a className="nav-link" onClick={() => {props.onLinkClick("Opportunities")}}>
                             <span className="sidebar-mini"> &nbsp; </span>
                             <span className="sidebar-normal"> Donation Analysis </span>
                             </a>
                          </li>
